...
export default function AddBookButton(){
    const [hover, setHover] = useState({backgroundColor: "white", cursor: "none"})
    ...
    return (
        <div>
            <Container style={containerStyle} onMouseEnter={handleMouseEnter} onMouseLeave={handleMouseLeave} className="d-flex justify-content-between">
