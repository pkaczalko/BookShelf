...
import scrollRightIcon from "../../../assets/arrow_left.png"
...
export default function ButtonLeft(props){
    ...
    const nextButtonStyle = {position: "absolute", top: "55%", left: "0", transform: hover.transform,
                             marginLeft:"16.5px", opacity:hover.opacity, boxShadow:hover.boxShadow, 
